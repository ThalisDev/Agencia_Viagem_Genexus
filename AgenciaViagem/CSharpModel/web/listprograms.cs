...
namespace GeneXus.Programs {
   public class listprograms : GXProcedure
   {
      ...
      {
         this.AV9ProgramNames = new GXBaseCollection<SdtProgramNames_ProgramName>( context, "ProgramName", "AgenciaViagem") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBaseCollection<SdtProgramNames_ProgramName> aP0_ProgramNames )
      {
         ...
         objlistprograms.AV9ProgramNames = new GXBaseCollection<SdtProgramNames_ProgramName>( context, "ProgramName", "AgenciaViagem") ;
      ...
      void executePrivate( )
      {
         ...
         AV9ProgramNames = new GXBaseCollection<SdtProgramNames_ProgramName>( context, "ProgramName", "AgenciaViagem");
         AV11name = "WWaeroporto";
         AV12description = "aeroportoes";
         AV13link = formatLink("wwaeroporto.aspx") ;
         ...
         AV11name = "WWatracao";
         AV12description = "atracaos";
         AV13link = formatLink("wwatracao.aspx") ;
         /* Execute user subroutine: 'ADDPROGRAM' */
         S111 ();
         if ( returnInSub )
         {
         ...
         AV11name = "WWVoo";
         AV12description = "Voos";
         AV13link = formatLink("wwvoo.aspx") ;
         /* Execute user subroutine: 'ADDPROGRAM' */
         S111 ();
         if ( returnInSub )
         {
