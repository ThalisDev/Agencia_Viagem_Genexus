...
namespace GeneXus.Programs {
   public class wwatracao : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwatracao( )
      {
      ...
      public wwatracao( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV11Nome, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20217152238679", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwatracao.aspx") +"\">") ;
      ...
      {
         return formatLink("wwatracao.aspx")  ;
      }
      ...
      protected void WB0T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "atracaos", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_WWatracao.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWatracao.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavNome_Internalname, "Nome", "col-sm-3 FilterSearchAttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavNome_Internalname, AV11Nome, StringUtil.RTrim( context.localUtil.Format( AV11Nome, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nome", edtavNome_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavNome_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWatracao.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "Categoria Nome") ;
               context.WriteHtmlTextNl( "</th>") ;
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "pais Cidade Nome") ;
               context.WriteHtmlTextNl( "</th>") ;
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A7atracaoID), 6, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A2Nome);
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtNome_Link));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A8paisID), 6, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A9Paisnome);
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtPaisnome_Link));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A10CategoriaID), 6, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A11CategoriaNome);
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtCategoriaNome_Link));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", context.convertURL( A12Imagem));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A13paisCidadeID), 6, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A14paisCidadeNome);
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START0T2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "atracaos", 0) ;
         }
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A12Imagem)) ? A40000Imagem_GXI : context.convertURL( context.PathToRelativeUrl( A12Imagem))), !bGXsfl_25_Refreshing);
      ...
      protected void RF0T2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000T2 */
            pr_default.execute(0, new Object[] {lV11Nome, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_25_idx), 4, 0), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A14paisCidadeNome = H000T2_A14paisCidadeNome[0];
               A13paisCidadeID = H000T2_A13paisCidadeID[0];
               n13paisCidadeID = H000T2_n13paisCidadeID[0];
               A40000Imagem_GXI = H000T2_A40000Imagem_GXI[0];
               AssignProp("", false, edtImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A12Imagem)) ? A40000Imagem_GXI : context.convertURL( context.PathToRelativeUrl( A12Imagem))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtImagem_Internalname, "SrcSet", context.GetImageSrcSet( A12Imagem), true);
               A11CategoriaNome = H000T2_A11CategoriaNome[0];
               A10CategoriaID = H000T2_A10CategoriaID[0];
               A9Paisnome = H000T2_A9Paisnome[0];
               A8paisID = H000T2_A8paisID[0];
               n8paisID = H000T2_n8paisID[0];
               A2Nome = H000T2_A2Nome[0];
               A7atracaoID = H000T2_A7atracaoID[0];
               A12Imagem = H000T2_A12Imagem[0];
               AssignProp("", false, edtImagem_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A12Imagem)) ? A40000Imagem_GXI : context.convertURL( context.PathToRelativeUrl( A12Imagem))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtImagem_Internalname, "SrcSet", context.GetImageSrcSet( A12Imagem), true);
               A11CategoriaNome = H000T2_A11CategoriaNome[0];
               A9Paisnome = H000T2_A9Paisnome[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_ATRACAOID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A7atracaoID), "ZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11Nome = StringUtil.Concat( StringUtil.RTrim( AV11Nome), "%", "");
         /* Using cursor H000T3 */
         pr_default.execute(1, new Object[] {lV11Nome});
      ...
      private void E140T2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("atracao.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A7atracaoID,6,0))}, new string[] {"Mode","atracaoID"}) ;
         edtavDelete_Link = formatLink("atracao.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A7atracaoID,6,0))}, new string[] {"Mode","atracaoID"}) ;
         edtNome_Link = formatLink("viewatracao.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A7atracaoID,6,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"atracaoID","TabCode"}) ;
      ...
      protected void E110T2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("atracao.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","atracaoID"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "atracao";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021715223875", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwatracao.js", "?2021715223875", false, true);
         }
      ...
      {
         edtatracaoID_Internalname = "ATRACAOID_"+sGXsfl_25_idx;
         edtNome_Internalname = "NOME_"+sGXsfl_25_idx;
         edtpaisID_Internalname = "PAISID_"+sGXsfl_25_idx;
         edtPaisnome_Internalname = "PAISNOME_"+sGXsfl_25_idx;
         edtCategoriaID_Internalname = "CATEGORIAID_"+sGXsfl_25_idx;
         edtCategoriaNome_Internalname = "CATEGORIANOME_"+sGXsfl_25_idx;
         edtImagem_Internalname = "IMAGEM_"+sGXsfl_25_idx;
         edtpaisCidadeID_Internalname = "PAISCIDADEID_"+sGXsfl_25_idx;
         edtpaisCidadeNome_Internalname = "PAISCIDADENOME_"+sGXsfl_25_idx;
      ...
      {
         edtatracaoID_Internalname = "ATRACAOID_"+sGXsfl_25_fel_idx;
         edtNome_Internalname = "NOME_"+sGXsfl_25_fel_idx;
         edtpaisID_Internalname = "PAISID_"+sGXsfl_25_fel_idx;
         edtPaisnome_Internalname = "PAISNOME_"+sGXsfl_25_fel_idx;
         edtCategoriaID_Internalname = "CATEGORIAID_"+sGXsfl_25_fel_idx;
         edtCategoriaNome_Internalname = "CATEGORIANOME_"+sGXsfl_25_fel_idx;
         edtImagem_Internalname = "IMAGEM_"+sGXsfl_25_fel_idx;
         edtpaisCidadeID_Internalname = "PAISCIDADEID_"+sGXsfl_25_fel_idx;
         edtpaisCidadeNome_Internalname = "PAISCIDADENOME_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtatracaoID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A7atracaoID), 6, 0, ",", "")),context.localUtil.Format( (decimal)(A7atracaoID), "ZZZZZ9"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtatracaoID_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)6,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtpaisID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A8paisID), 6, 0, ",", "")),context.localUtil.Format( (decimal)(A8paisID), "ZZZZZ9"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtpaisID_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)6,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCategoriaNome_Internalname,(string)A11CategoriaNome,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtCategoriaNome_Link,(string)"",(string)"",(string)"",(string)edtCategoriaNome_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(string)"",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtImagem_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)0,(string)"",(string)"",(short)1,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn WWOptionalColumn",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A12Imagem_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtpaisCidadeID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A13paisCidadeID), 6, 0, ",", "")),context.localUtil.Format( (decimal)(A13paisCidadeID), "ZZZZZ9"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtpaisCidadeID_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)6,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11Nome',fld:'vNOME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140T2',iparms:[{av:'A7atracaoID',fld:'ATRACAOID',pic:'ZZZZZ9',hsh:true},{av:'A8paisID',fld:'PAISID',pic:'ZZZZZ9'},{av:'A10CategoriaID',fld:'CATEGORIAID',pic:'ZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtNome_Link',ctrl:'NOME',prop:'Link'},{av:'edtPaisnome_Link',ctrl:'PAISNOME',prop:'Link'},{av:'edtCategoriaNome_Link',ctrl:'CATEGORIANOME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110T2',iparms:[{av:'A7atracaoID',fld:'ATRACAOID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11Nome',fld:'vNOME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11Nome',fld:'vNOME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11Nome',fld:'vNOME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11Nome',fld:'vNOME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11Nome = "";
         H000T2_A14paisCidadeNome = new string[] {""} ;
         H000T2_A13paisCidadeID = new int[1] ;
         H000T2_n13paisCidadeID = new bool[] {false} ;
         H000T2_A40000Imagem_GXI = new string[] {""} ;
         H000T2_A11CategoriaNome = new string[] {""} ;
         H000T2_A10CategoriaID = new int[1] ;
         H000T2_A9Paisnome = new string[] {""} ;
         H000T2_A8paisID = new int[1] ;
         H000T2_n8paisID = new bool[] {false} ;
         H000T2_A2Nome = new string[] {""} ;
         H000T2_A7atracaoID = new int[1] ;
         H000T2_A12Imagem = new string[] {""} ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwatracao__default(),
            new Object[][] {
                new Object[] {
               H000T2_A14paisCidadeNome, H000T2_A13paisCidadeID, H000T2_n13paisCidadeID, H000T2_A40000Imagem_GXI, H000T2_A11CategoriaNome, H000T2_A10CategoriaID, H000T2_A9Paisnome, H000T2_A8paisID, H000T2_n8paisID, H000T2_A2Nome,
               H000T2_A7atracaoID, H000T2_A12Imagem
               }
               , new Object[] {
      ...
      private string[] H000T2_A14paisCidadeNome ;
      private int[] H000T2_A13paisCidadeID ;
      private bool[] H000T2_n13paisCidadeID ;
      private string[] H000T2_A40000Imagem_GXI ;
      private string[] H000T2_A11CategoriaNome ;
      private int[] H000T2_A10CategoriaID ;
      private string[] H000T2_A9Paisnome ;
      private int[] H000T2_A8paisID ;
      private bool[] H000T2_n8paisID ;
      private string[] H000T2_A2Nome ;
      private int[] H000T2_A7atracaoID ;
      private string[] H000T2_A12Imagem ;
   ...
   public class wwatracao__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A2Nome )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T4.[paisCidadeNome], T1.[paisCidadeID], T1.[Imagem_GXI], T2.[CategoriaNome], T1.[CategoriaID], T3.[Paisnome], T1.[paisID], T1.[Nome], T1.[atracaoID], T1.[Imagem]";
         sFromString = " FROM ((([atracao] T1 INNER JOIN [Categoria] T2 ON T2.[CategoriaID] = T1.[CategoriaID]) LEFT JOIN [pais] T3 ON T3.[paisID] = T1.[paisID]) LEFT JOIN [paisCidade] T4 ON T4.[paisID] = T1.[paisID] AND T4.[paisCidadeID] = T1.[paisCidadeID])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11Nome)) )
         {
            AddWhere(sWhereString, "(T1.[Nome] like @lV11Nome)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY T1.[Nome]";
                                             ...
                                             string A2Nome )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((([atracao] T1 INNER JOIN [Categoria] T4 ON T4.[CategoriaID] = T1.[CategoriaID]) LEFT JOIN [pais] T2 ON T2.[paisID] = T1.[paisID]) LEFT JOIN [paisCidade] T3 ON T3.[paisID] = T1.[paisID] AND T3.[paisCidadeID] = T1.[paisCidadeID])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11Nome)) )
         {
            AddWhere(sWhereString, "(T1.[Nome] like @lV11Nome)");
         }
