   ...
   public class viewpais : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12paisID = (int)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202171522281675", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("Paisnome", StringUtil.RTrim( context.localUtil.Format( A9Paisnome, "")));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Cidadewc == null ) )
         {
            WebComp_Cidadewc.componentjscripts();
         }
      }
      ...
      protected void WB0L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPaisnome_Internalname, A9Paisnome, StringUtil.RTrim( context.localUtil.Format( A9Paisnome, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisnome_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtPaisnome_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Viewpais.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCidade_title_Internalname, "Cidade", "", "", lblCidade_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Viewpais.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            context.WriteHtmlText( "Cidade") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABContainer"+"panel2"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablecidade_Internalname, 1, 0, "px", 0, "px", "TabsFormContainer", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0038"+"", StringUtil.RTrim( WebComp_Cidadewc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0038"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Cidadewc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldCidadewc), StringUtil.Lower( WebComp_Cidadewc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0038"+"");
                  }
                  WebComp_Cidadewc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldCidadewc), StringUtil.Lower( WebComp_Cidadewc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START0L2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Viewpais", 0) ;
         }
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldCidadewc = cgiGet( "W0038");
                           if ( ( StringUtil.Len( OldCidadewc) == 0 ) || ( StringUtil.StrCmp(OldCidadewc, WebComp_Cidadewc_Component) != 0 ) )
                           {
                              WebComp_Cidadewc = getWebComponent(GetType(), "GeneXus.Programs", OldCidadewc, new Object[] {context} );
                              WebComp_Cidadewc.ComponentInit();
                              WebComp_Cidadewc.Name = "OldCidadewc";
                              WebComp_Cidadewc_Component = OldCidadewc;
                           }
                           if ( StringUtil.Len( WebComp_Cidadewc_Component) != 0 )
                           {
                              WebComp_Cidadewc.componentprocess("W0038", "", sEvt);
                           }
                           WebComp_Cidadewc_Component = OldCidadewc;
                        }
                     }
      ...
      protected void RF0L2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Cidadewc_Component) != 0 )
               {
                  WebComp_Cidadewc.componentstart();
               }
            }
         }
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A8paisID = H000L2_A8paisID[0];
               A9Paisnome = H000L2_A9Paisnome[0];
      ...
      protected void STRUP0L0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12paisID = (int)(context.localUtil.CToN( cgiGet( "vPAISID"), ",", "."));
      ...
      protected void E110L2( )
      {
         ...
         {
            A8paisID = H000L3_A8paisID[0];
            A9Paisnome = H000L3_A9Paisnome[0];
            AssignAttri("", false, "A9Paisnome", A9Paisnome);
            AV16GXLvl6 = 1;
            Form.Caption = A9Paisnome;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(int)AV12paisID});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Cidade") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Cidadewc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Cidadewc_Component), StringUtil.Lower( "paisCidadeWC")) != 0 )
            {
               WebComp_Cidadewc = getWebComponent(GetType(), "GeneXus.Programs", "paiscidadewc", new Object[] {context} );
               WebComp_Cidadewc.ComponentInit();
               WebComp_Cidadewc.Name = "paisCidadeWC";
               WebComp_Cidadewc_Component = "paisCidadeWC";
            }
            if ( StringUtil.Len( WebComp_Cidadewc_Component) != 0 )
            {
               WebComp_Cidadewc.setjustcreated();
               WebComp_Cidadewc.componentprepare(new Object[] {(string)"W0038",(string)"",(int)AV12paisID});
               WebComp_Cidadewc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Cidadewc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0038"+"");
               WebComp_Cidadewc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Cidadewc == null ) )
         {
            if ( StringUtil.Len( WebComp_Cidadewc_Component) != 0 )
            {
               WebComp_Cidadewc.componentthemes();
            }
         }
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202171522281689", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewpais.js", "?202171522281690", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         lblCidade_title_Internalname = "CIDADE_TITLE";
         divTablecidade_Internalname = "TABLECIDADE";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12paisID',fld:'vPAISID',pic:'ZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A9Paisnome',fld:'PAISNOME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         OldGeneralwc = "";
         lblCidade_title_Jsonclick = "";
         WebComp_Cidadewc_Component = "";
         OldCidadewc = "";
         sEvt = "";
         EvtGridId = "";
         EvtRowId = "";
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000L2_A8paisID = new int[1] ;
         H000L2_A9Paisnome = new string[] {""} ;
         hsh = "";
         H000L3_A8paisID = new int[1] ;
         H000L3_A9Paisnome = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewpais__default(),
            new Object[][] {
                new Object[] {
               H000L2_A8paisID, H000L2_A9Paisnome
               }
               , new Object[] {
               H000L3_A8paisID, H000L3_A9Paisnome
               }
            }
         );
         WebComp_Generalwc = new GeneXus.Http.GXNullWebComponent();
         WebComp_Cidadewc = new GeneXus.Http.GXNullWebComponent();
         AV15Pgmname = "Viewpais";
         /* GeneXus formulas. */
         AV15Pgmname = "Viewpais";
         context.Gx_err = 0;
      ...
      private string lblCidade_title_Internalname ;
      private string lblCidade_title_Jsonclick ;
      private string divTablecidade_Internalname ;
      private string WebComp_Cidadewc_Component ;
      private string OldCidadewc ;
      private string sEvt ;
      ...
      private bool bDynCreated_Cidadewc ;
      private string A9Paisnome ;
      private GXWebComponent WebComp_Generalwc ;
      private GXWebComponent WebComp_Cidadewc ;
      private GXProperties forbiddenHiddens ;
      private GXUserControl ucTab ;
      private IGxDataStore dsDefault ;
      private IDataStoreProvider pr_default ;
      private int[] H000L2_A8paisID ;
      private string[] H000L2_A9Paisnome ;
      private int[] H000L3_A8paisID ;
      private string[] H000L3_A9Paisnome ;
   ...
   public class viewpais__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000L2", "SELECT [paisID], [Paisnome] FROM [pais] WHERE [paisID] = @AV12paisID ORDER BY [paisID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000L2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000L3", "SELECT [paisID], [Paisnome] FROM [pais] WHERE [paisID] = @AV12paisID ORDER BY [paisID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000L3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
