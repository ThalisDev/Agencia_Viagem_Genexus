...
namespace GeneXus.Programs {
   public class aeroportogeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public aeroportogeneral( )
      {
      ...
      public aeroportogeneral( IGxContext context )
      {
      ...
      {
         this.A17AeroportoId = aP0_AeroportoId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "A17AeroportoId", StringUtil.LTrimStr( (decimal)(A17AeroportoId), 6, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)A17AeroportoId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "aeroporto General") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?20217152238733", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("aeroportogeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A17AeroportoId,6,0))}, new string[] {"AeroportoId"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", sPrefix+"hsh"+"aeroportoGeneral");
         forbiddenHiddens.Add("paisID", context.localUtil.Format( (decimal)(A8paisID), "ZZZZZ9"));
         GxWebStd.gx_hidden_field( context, sPrefix+"hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("aeroportogeneral:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA17AeroportoId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA17AeroportoId), 6, 0, ",", "")));
      }
      ...
      {
         return "aeroportoGeneral" ;
      }

      public override string GetPgmdesc( )
      {
         return "aeroporto General" ;
      }
      ...
      protected void WB0X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "aeroportogeneral.aspx");
            }
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Modifica", bttBtnupdate_Jsonclick, 7, "Modifica", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e110x1_client"+"'", TempTags, "", 2, "HLP_aeroportoGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Eliminar", bttBtndelete_Jsonclick, 7, "Eliminar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e120x1_client"+"'", TempTags, "", 2, "HLP_aeroportoGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtAeroportoNome_Internalname, A18AeroportoNome, StringUtil.RTrim( context.localUtil.Format( A18AeroportoNome, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAeroportoNome_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtAeroportoNome_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_aeroportoGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPaisnome_Internalname, A9Paisnome, StringUtil.RTrim( context.localUtil.Format( A9Paisnome, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", edtPaisnome_Link, "", "", "", edtPaisnome_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtPaisnome_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_aeroportoGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtpaisCidadeNome_Internalname, A14paisCidadeNome, StringUtil.RTrim( context.localUtil.Format( A14paisCidadeNome, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtpaisCidadeNome_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtpaisCidadeNome_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_aeroportoGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START0X2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "aeroporto General", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void STRUP0X0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA17AeroportoId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA17AeroportoId"), ",", "."));
            ...
            {
               GXUtil.WriteLogError("aeroportogeneral:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void S112( )
      {
         ...
         AV7TrnContext.gxTpr_Transactionname = "aeroporto";
         AV8TrnContextAtt = new SdtTransactionContext_Attribute(context);
         AV8TrnContextAtt.gxTpr_Attributename = "AeroportoId";
         AV8TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6AeroportoId), 6, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A17AeroportoId = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "A17AeroportoId", StringUtil.LTrimStr( (decimal)(A17AeroportoId), 6, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA17AeroportoId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "aeroportogeneral", GetJustCreated( ));
         ...
         {
            A17AeroportoId = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "A17AeroportoId", StringUtil.LTrimStr( (decimal)(A17AeroportoId), 6, 0));
         }
         wcpOA17AeroportoId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA17AeroportoId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( A17AeroportoId != wcpOA17AeroportoId ) ) )
         {
            setjustcreated();
         }
         wcpOA17AeroportoId = A17AeroportoId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA17AeroportoId = cgiGet( sPrefix+"A17AeroportoId_CTRL");
         if ( StringUtil.Len( sCtrlA17AeroportoId) > 0 )
         {
            A17AeroportoId = (int)(context.localUtil.CToN( cgiGet( sCtrlA17AeroportoId), ",", "."));
            AssignAttri(sPrefix, false, "A17AeroportoId", StringUtil.LTrimStr( (decimal)(A17AeroportoId), 6, 0));
         }
         else
         {
            A17AeroportoId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"A17AeroportoId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A17AeroportoId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A17AeroportoId), 6, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA17AeroportoId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A17AeroportoId_CTRL", StringUtil.RTrim( sCtrlA17AeroportoId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20217152238749", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("aeroportogeneral.js", "?20217152238749", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         edtAeroportoId_Internalname = sPrefix+"AEROPORTOID";
         edtAeroportoNome_Internalname = sPrefix+"AEROPORTONOME";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A17AeroportoId',fld:'AEROPORTOID',pic:'ZZZZZ9'},{av:'A8paisID',fld:'PAISID',pic:'ZZZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOUPDATE'","{handler:'E110X1',iparms:[{av:'A17AeroportoId',fld:'AEROPORTOID',pic:'ZZZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E120X1',iparms:[{av:'A17AeroportoId',fld:'AEROPORTOID',pic:'ZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000X2_A17AeroportoId = new int[1] ;
         H000X2_A14paisCidadeNome = new string[] {""} ;
         H000X2_A13paisCidadeID = new int[1] ;
         H000X2_A9Paisnome = new string[] {""} ;
         H000X2_A8paisID = new int[1] ;
         H000X2_A18AeroportoNome = new string[] {""} ;
         hsh = "";
         AV7TrnContext = new SdtTransactionContext(context);
         ...
         sCtrlA17AeroportoId = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aeroportogeneral__default(),
            new Object[][] {
                new Object[] {
               H000X2_A17AeroportoId, H000X2_A14paisCidadeNome, H000X2_A13paisCidadeID, H000X2_A9Paisnome, H000X2_A8paisID, H000X2_A18AeroportoNome
               }
            }
         );
         AV13Pgmname = "aeroportoGeneral";
      ...
      private int wcpOA17AeroportoId ;
      ...
      private string hsh ;
      private string sCtrlA17AeroportoId ;
      ...
      private int[] H000X2_A17AeroportoId ;
      private string[] H000X2_A14paisCidadeNome ;
      private int[] H000X2_A13paisCidadeID ;
      private string[] H000X2_A9Paisnome ;
      private int[] H000X2_A8paisID ;
      private string[] H000X2_A18AeroportoNome ;
   ...
   public class aeroportogeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000X2", "SELECT T1.[AeroportoId], T3.[paisCidadeNome], T1.[paisCidadeID], T2.[Paisnome], T1.[paisID], T1.[AeroportoNome] FROM (([aeroporto] T1 INNER JOIN [pais] T2 ON T2.[paisID] = T1.[paisID]) INNER JOIN [paisCidade] T3 ON T3.[paisID] = T1.[paisID] AND T3.[paisCidadeID] = T1.[paisCidadeID]) WHERE T1.[AeroportoId] = @AeroportoId ORDER BY T1.[AeroportoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000X2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
