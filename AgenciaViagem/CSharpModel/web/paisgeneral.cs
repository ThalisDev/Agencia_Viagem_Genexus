...
namespace GeneXus.Programs {
   public class paisgeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)A8paisID});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202171522281743", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("paisgeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A8paisID,6,0))}, new string[] {"paisID"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA8paisID", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA8paisID), 6, 0, ",", "")));
      }
      ...
      protected void WB0N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Modifica", bttBtnupdate_Jsonclick, 7, "Modifica", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e110n1_client"+"'", TempTags, "", 2, "HLP_paisGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Eliminar", bttBtndelete_Jsonclick, 7, "Eliminar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e120n1_client"+"'", TempTags, "", 2, "HLP_paisGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPaisnome_Internalname, A9Paisnome, StringUtil.RTrim( context.localUtil.Format( A9Paisnome, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisnome_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtPaisnome_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_paisGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtPaisCidadeLastid_Internalname, "Cidade Lastid", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPaisCidadeLastid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A16PaisCidadeLastid), 6, 0, ",", "")), ((edtPaisCidadeLastid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A16PaisCidadeLastid), "ZZZZZ9")) : context.localUtil.Format( (decimal)(A16PaisCidadeLastid), "ZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisCidadeLastid_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtPaisCidadeLastid_Enabled, 0, "number", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "", "HLP_paisGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF0N2( )
      {
         ...
         {
            /* Using cursor H000N2 */
            pr_default.execute(0, new Object[] {A8paisID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A16PaisCidadeLastid = H000N2_A16PaisCidadeLastid[0];
               AssignAttri(sPrefix, false, "A16PaisCidadeLastid", StringUtil.LTrimStr( (decimal)(A16PaisCidadeLastid), 6, 0));
               A9Paisnome = H000N2_A9Paisnome[0];
      ...
      protected void STRUP0N0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA8paisID = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA8paisID"), ",", "."));
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A8paisID = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "A8paisID", StringUtil.LTrimStr( (decimal)(A8paisID), 6, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA8paisID = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            A8paisID = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "A8paisID", StringUtil.LTrimStr( (decimal)(A8paisID), 6, 0));
         }
         wcpOA8paisID = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA8paisID"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( A8paisID != wcpOA8paisID ) ) )
         {
            setjustcreated();
         }
         wcpOA8paisID = A8paisID;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA8paisID = cgiGet( sPrefix+"A8paisID_CTRL");
         if ( StringUtil.Len( sCtrlA8paisID) > 0 )
         {
            A8paisID = (int)(context.localUtil.CToN( cgiGet( sCtrlA8paisID), ",", "."));
            AssignAttri(sPrefix, false, "A8paisID", StringUtil.LTrimStr( (decimal)(A8paisID), 6, 0));
         }
         else
         {
            A8paisID = (int)(context.localUtil.CToN( cgiGet( sPrefix+"A8paisID_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A8paisID_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A8paisID), 6, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA8paisID)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A8paisID_CTRL", StringUtil.RTrim( sCtrlA8paisID));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202171522281754", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("paisgeneral.js", "?202171522281754", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         edtPaisCidadeLastid_Internalname = sPrefix+"PAISCIDADELASTID";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A8paisID',fld:'PAISID',pic:'ZZZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOUPDATE'","{handler:'E110N1',iparms:[{av:'A8paisID',fld:'PAISID',pic:'ZZZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E120N1',iparms:[{av:'A8paisID',fld:'PAISID',pic:'ZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000N2_A8paisID = new int[1] ;
         H000N2_A16PaisCidadeLastid = new int[1] ;
         H000N2_A9Paisnome = new string[] {""} ;
         AV7TrnContext = new SdtTransactionContext(context);
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.paisgeneral__default(),
            new Object[][] {
                new Object[] {
               H000N2_A8paisID, H000N2_A16PaisCidadeLastid, H000N2_A9Paisnome
               }
            }
         );
         AV13Pgmname = "paisGeneral";
      ...
      private int[] H000N2_A8paisID ;
      private int[] H000N2_A16PaisCidadeLastid ;
      private string[] H000N2_A9Paisnome ;
   ...
   public class paisgeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000N2", "SELECT [paisID], [PaisCidadeLastid], [Paisnome] FROM [pais] WHERE [paisID] = @paisID ORDER BY [paisID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000N2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
