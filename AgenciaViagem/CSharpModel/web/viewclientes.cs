...
namespace GeneXus.Programs {
   public class viewclientes : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewclientes( )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12ClienteID = (int)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20217152238437", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewclientes.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12ClienteID,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"ClienteID","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewClientes");
         forbiddenHiddens.Add("ClienteNome", StringUtil.RTrim( context.localUtil.Format( A3ClienteNome, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewclientes:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("viewclientes.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12ClienteID,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"ClienteID","TabCode"})  ;
      }
      ...
      protected void WB0P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Clientes Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Clientes", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewClientes.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtClienteNome_Internalname, A3ClienteNome, StringUtil.RTrim( context.localUtil.Format( A3ClienteNome, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtClienteNome_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtClienteNome_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_ViewClientes.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewClientes.htm");
            /* Div Control */
      ...
      protected void RF0P2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1ClienteID = H000P2_A1ClienteID[0];
               A3ClienteNome = H000P2_A3ClienteNome[0];
      ...
      protected void STRUP0P0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12ClienteID = (int)(context.localUtil.CToN( cgiGet( "vCLIENTEID"), ",", "."));
            ...
            {
               GXUtil.WriteLogError("viewclientes:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110P2( )
      {
         ...
         {
            A1ClienteID = H000P3_A1ClienteID[0];
            A3ClienteNome = H000P3_A3ClienteNome[0];
            AssignAttri("", false, "A3ClienteNome", A3ClienteNome);
            AV16GXLvl6 = 1;
            Form.Caption = A3ClienteNome;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(int)AV12ClienteID});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20217152238449", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewclientes.js", "?20217152238450", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12ClienteID',fld:'vCLIENTEID',pic:'ZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A3ClienteNome',fld:'CLIENTENOME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000P2_A1ClienteID = new int[1] ;
         H000P2_A3ClienteNome = new string[] {""} ;
         hsh = "";
         H000P3_A1ClienteID = new int[1] ;
         H000P3_A3ClienteNome = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewclientes__default(),
            new Object[][] {
                new Object[] {
               H000P2_A1ClienteID, H000P2_A3ClienteNome
               }
               , new Object[] {
               H000P3_A1ClienteID, H000P3_A3ClienteNome
               }
            }
         );
      ...
      private int[] H000P2_A1ClienteID ;
      private string[] H000P2_A3ClienteNome ;
      private int[] H000P3_A1ClienteID ;
      private string[] H000P3_A3ClienteNome ;
   ...
   public class viewclientes__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000P2", "SELECT [ClienteID], [ClienteNome] FROM [Clientes] WHERE [ClienteID] = @AV12ClienteID ORDER BY [ClienteID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000P2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000P3", "SELECT [ClienteID], [ClienteNome] FROM [Clientes] WHERE [ClienteID] = @AV12ClienteID ORDER BY [ClienteID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000P3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
