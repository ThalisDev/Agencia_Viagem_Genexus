...
namespace GeneXus.Programs {
   public class viewatracao : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewatracao( )
      {
      ...
      public viewatracao( IGxContext context )
      {
      ...
      public void execute( int aP0_atracaoID ,
                           string aP1_TabCode )
      {
         this.AV12atracaoID = aP0_atracaoID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12atracaoID = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12atracaoID", StringUtil.LTrimStr( (decimal)(AV12atracaoID), 6, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vATRACAOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12atracaoID), "ZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20217152238514", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewatracao.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12atracaoID,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"atracaoID","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"Viewatracao");
         forbiddenHiddens.Add("Nome", StringUtil.RTrim( context.localUtil.Format( A2Nome, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewatracao:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vATRACAOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12atracaoID), 6, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vATRACAOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12atracaoID), "ZZZZZ9"), context));
      ...
      {
         return formatLink("viewatracao.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12atracaoID,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"atracaoID","TabCode"})  ;
      }
      ...
      protected void WB0S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "atracao Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_Viewatracao.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "atracaos", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_Viewatracao.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtNome_Internalname, A2Nome, StringUtil.RTrim( context.localUtil.Format( A2Nome, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtNome_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtNome_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Viewatracao.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Viewatracao.htm");
            /* Div Control */
      ...
      protected void START0S2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Viewatracao", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0S2( )
      {
         ...
         {
            /* Using cursor H000S2 */
            pr_default.execute(0, new Object[] {AV12atracaoID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A7atracaoID = H000S2_A7atracaoID[0];
               A2Nome = H000S2_A2Nome[0];
      ...
      protected void STRUP0S0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12atracaoID = (int)(context.localUtil.CToN( cgiGet( "vATRACAOID"), ",", "."));
            ...
            {
               GXUtil.WriteLogError("viewatracao:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110S2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H000S3 */
         pr_default.execute(1, new Object[] {AV12atracaoID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A7atracaoID = H000S3_A7atracaoID[0];
            A2Nome = H000S3_A2Nome[0];
            AssignAttri("", false, "A2Nome", A2Nome);
            AV16GXLvl6 = 1;
            Form.Caption = A2Nome;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwatracao.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "atracaoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "atracaogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "atracaoGeneral";
               WebComp_Generalwc_Component = "atracaoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(int)AV12atracaoID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12atracaoID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV12atracaoID", StringUtil.LTrimStr( (decimal)(AV12atracaoID), 6, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vATRACAOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12atracaoID), "ZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20217152238526", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewatracao.js", "?20217152238526", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12atracaoID',fld:'vATRACAOID',pic:'ZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A2Nome',fld:'NOME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000S2_A7atracaoID = new int[1] ;
         H000S2_A2Nome = new string[] {""} ;
         hsh = "";
         H000S3_A7atracaoID = new int[1] ;
         H000S3_A2Nome = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewatracao__default(),
            new Object[][] {
                new Object[] {
               H000S2_A7atracaoID, H000S2_A2Nome
               }
               , new Object[] {
               H000S3_A7atracaoID, H000S3_A2Nome
               }
            }
         );
      ...
      private int AV12atracaoID ;
      private int wcpOAV12atracaoID ;
      ...
      private int[] H000S2_A7atracaoID ;
      private string[] H000S2_A2Nome ;
      private int[] H000S3_A7atracaoID ;
      private string[] H000S3_A2Nome ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewatracao__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12atracaoID",GXType.Int32,6,0)
          };
          Object[] prmH000S3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000S2", "SELECT [atracaoID], [Nome] FROM [atracao] WHERE [atracaoID] = @AV12atracaoID ORDER BY [atracaoID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000S2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000S3", "SELECT [atracaoID], [Nome] FROM [atracao] WHERE [atracaoID] = @AV12atracaoID ORDER BY [atracaoID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000S3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
