...
namespace GeneXus.Programs {
   public class viewvoo : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewvoo( )
      {
      ...
      public viewvoo( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12VooId = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12VooId", StringUtil.LTrimStr( (decimal)(AV12VooId), 6, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vVOOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12VooId), "ZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20217152238621", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewvoo.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12VooId,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"VooId","TabCode"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vVOOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12VooId), 6, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vVOOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12VooId), "ZZZZZ9"), context));
      ...
      {
         return formatLink("viewvoo.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12VooId,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"VooId","TabCode"})  ;
      }
      ...
      protected void WB100( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Voo Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewVoo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Voos", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewVoo.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtVooEmbarqueAeroportoNome_Internalname, A21VooEmbarqueAeroportoNome, StringUtil.RTrim( context.localUtil.Format( A21VooEmbarqueAeroportoNome, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVooEmbarqueAeroportoNome_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtVooEmbarqueAeroportoNome_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_ViewVoo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewVoo.htm");
            /* Div Control */
      ...
      protected void START102( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Voo", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF102( )
      {
         ...
         {
            /* Using cursor H00102 */
            pr_default.execute(0, new Object[] {AV12VooId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A20VooEmbarqueAeroportoID = H00102_A20VooEmbarqueAeroportoID[0];
               A19VooId = H00102_A19VooId[0];
               A21VooEmbarqueAeroportoNome = H00102_A21VooEmbarqueAeroportoNome[0];
      ...
      protected void STRUP100( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12VooId = (int)(context.localUtil.CToN( cgiGet( "vVOOID"), ",", "."));
      ...
      protected void E11102( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H00103 */
         pr_default.execute(1, new Object[] {AV12VooId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A20VooEmbarqueAeroportoID = H00103_A20VooEmbarqueAeroportoID[0];
            A19VooId = H00103_A19VooId[0];
            A21VooEmbarqueAeroportoNome = H00103_A21VooEmbarqueAeroportoNome[0];
            AssignAttri("", false, "A21VooEmbarqueAeroportoNome", A21VooEmbarqueAeroportoNome);
            A21VooEmbarqueAeroportoNome = H00103_A21VooEmbarqueAeroportoNome[0];
            AssignAttri("", false, "A21VooEmbarqueAeroportoNome", A21VooEmbarqueAeroportoNome);
            AV16GXLvl6 = 1;
            Form.Caption = A21VooEmbarqueAeroportoNome;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwvoo.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "VooGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "voogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "VooGeneral";
               WebComp_Generalwc_Component = "VooGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(int)AV12VooId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12VooId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV12VooId", StringUtil.LTrimStr( (decimal)(AV12VooId), 6, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vVOOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12VooId), "ZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20217152238633", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewvoo.js", "?20217152238633", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12VooId',fld:'vVOOID',pic:'ZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H00102_A20VooEmbarqueAeroportoID = new int[1] ;
         H00102_A19VooId = new int[1] ;
         H00102_A21VooEmbarqueAeroportoNome = new string[] {""} ;
         H00103_A20VooEmbarqueAeroportoID = new int[1] ;
         H00103_A19VooId = new int[1] ;
         H00103_A21VooEmbarqueAeroportoNome = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewvoo__default(),
            new Object[][] {
                new Object[] {
               H00102_A20VooEmbarqueAeroportoID, H00102_A19VooId, H00102_A21VooEmbarqueAeroportoNome
               }
               , new Object[] {
               H00103_A20VooEmbarqueAeroportoID, H00103_A19VooId, H00103_A21VooEmbarqueAeroportoNome
               }
            }
         );
      ...
      private int AV12VooId ;
      private int wcpOAV12VooId ;
      ...
      private int[] H00102_A20VooEmbarqueAeroportoID ;
      private int[] H00102_A19VooId ;
      private string[] H00102_A21VooEmbarqueAeroportoNome ;
      private int[] H00103_A20VooEmbarqueAeroportoID ;
      private int[] H00103_A19VooId ;
      private string[] H00103_A21VooEmbarqueAeroportoNome ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewvoo__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12VooId",GXType.Int32,6,0)
          };
          Object[] prmH00103;
          ...
          def= new CursorDef[] {
              new CursorDef("H00102", "SELECT T1.[VooEmbarqueAeroportoID] AS VooEmbarqueAeroportoID, T1.[VooId], T2.[AeroportoNome] AS VooEmbarqueAeroportoNome FROM ([Voo] T1 INNER JOIN [aeroporto] T2 ON T2.[AeroportoId] = T1.[VooEmbarqueAeroportoID]) WHERE T1.[VooId] = @AV12VooId ORDER BY T1.[VooId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00102,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00103", "SELECT T1.[VooEmbarqueAeroportoID] AS VooEmbarqueAeroportoID, T1.[VooId], T2.[AeroportoNome] AS VooEmbarqueAeroportoNome FROM ([Voo] T1 INNER JOIN [aeroporto] T2 ON T2.[AeroportoId] = T1.[VooEmbarqueAeroportoID]) WHERE T1.[VooId] = @AV12VooId ORDER BY T1.[VooId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00103,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
