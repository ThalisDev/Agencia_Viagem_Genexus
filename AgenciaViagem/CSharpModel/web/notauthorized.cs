...
namespace GeneXus.Programs {
   public class notauthorized : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202171522222789", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void wb_table1_4_0F2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void wb_table2_13_0F2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void wb_table3_16_0F2e( bool wbgen )
      {
         if ( wbgen )
         {
         }
      ...
      protected void wb_table3_16_0F2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void wb_table2_13_0F2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void wb_table1_4_0F2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202171522222794", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("notauthorized.js", "?202171522222794", false, true);
